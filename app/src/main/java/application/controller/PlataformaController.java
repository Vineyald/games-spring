...
public class PlataformaController {
    ...
    public String list(Model ui) {
        ...
        return "plataforma/list"; // O JSP deve estar em /WEB-INF/jsp/plataforma/list.jsp
    }

    @RequestMapping("/insert")
    public String insert() {
        return "plataforma/insert"; // O JSP deve estar em /WEB-INF/jsp/plataforma/insert.jsp
    }
    ...
    public String update(@RequestParam("id") long id, Model ui) {
        ...
        if (plataforma.isPresent()) {
            ...
            return "plataforma/update"; // O JSP deve estar em /WEB-INF/jsp/plataforma/update.jsp
        }
        return "redirect:/plataforma/list";
    }
    ...
    public String delete(@RequestParam("id") long id, Model ui) {
        ...
        if (plataforma.isPresent()) {
            ui.addAttribute("plataforma", plataforma.get());
            return "plataforma/delete"; // O JSP deve estar em /WEB-INF/jsp/plataforma/delete.jsp
        }
        return "redirect:/plataforma/list";
    }
